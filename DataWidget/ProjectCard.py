...
from qfluentwidgets import (PushButton,PrimaryPushButton,FluentIcon,LineEdit,ToolButton,ListWidget,SimpleCardWidget,MessageBox,ImageLabel,BodyLabel,TableWidget,setFont,ProgressBar,HyperlinkButton,InfoBar,InfoBarPosition)
...
class ProjectCard(SimpleCardWidget):
    ...
    def __initWidget__(self):
        ...
        self.hCardLayout.setAlignment(Qt.AlignLeft)
    ...
    def addDataItem(self, dataObj: dict):
        ...
        dataDesc = dataObj.get("description", "No description")
